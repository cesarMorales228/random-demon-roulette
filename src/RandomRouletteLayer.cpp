...
void RandomRouletteLayer::updateUI() {
    ...
    switch(level->difficulty) {
        case DemonLevel::Difficulty::Easy: txt="Easy Demon"; col={0,255,0}; break;
        case DemonLevel::Difficulty::Medium: txt="Medium Demon"; col={255,255,0}; break;
        case DemonLevel::Difficulty::Hard: txt="Hard Demon"; col={255,128,0}; break;
        case DemonLevel::Difficulty::Extreme: txt="Extreme Demon"; col={255,0,0}; break;
    }
